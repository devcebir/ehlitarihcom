...
export const metadata = {
  ...
  description: "Türk Tarihi / Ehl-i Tarih",
};
...
export default function page() {
  return (
    ...
    max-[600px]:px-10 max-[570px]:px-3 max-[480px]:px-10 max-[325px]:px-5 max-[1670px]:my-5 max-[1240px]:my-10 max-[920px]:my-20 max-[540px]:my-[27rem] max-[500px]:my-[30rem] max-[360px]:my-[33rem]"
    >
      <div className="flex flex-col items-center justify-center text-center max-[500px]:text-start gap-3 my-5">
        <h3 className="text-3xl font-bold">Türk Tarihi</h3>
        <p className="text-lg">
          Bu sayfada yer alan linklere tıklayarak,{" "}
          <span className="font-bold">Türk</span> tarihinde önemli bir rol
          oynamış devletlerin detaylı hikayelerine ulaşabilirsiniz. Her bir
          sayfa, o devletin kuruluşundan yıkılışına kadar olan olayları, lider
          figürleri ve etkileşimde bulunduğu diğer medeniyetleri içeren
          bilgilerle doludur.
        </p>
      </div>
